    ...
    <VStack p={5}  maxW="1200px">
      ...
      >
        ...
        <VStack p={5} position="relative" top="-100px" >
          ...
          >
            <Text  textAlign="center" w="38%">Username </Text>
            <Text textAlign="center" w="45%">Email</Text>
          ...
          {data?.map((el) => (
            <HStack
              ...
              justifyContent={"space-between"}
            >
              <Text  textAlign="center" w="32%" >
                {el.username}
               
              </Text>
              <Text  textAlign="center" w="45%">{el.email}</Text>
              <Text  textAlign="center" w="8%">{el.age}</Text>
              <Text textAlign="center" w="25%">{el.gender}</Text>
